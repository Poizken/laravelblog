            ...
            <div class="col-md-8">
                <article class="post">
                    ...
                    <div class="post-content">
                        <header class="entry-header text-center text-uppercase">           @if($post->hasCategory())
                ...
                <div class="top-comment"><!--top comment-->
                    <img src="{{ $post->author->getImage() }}" class="pull-left" alt="">
                    ...
                    <div class="col-md-6">
                        @if($post->hasPrevious())
                            ...
                            <a href="{{ route('post.show', $post->getPrevious()->slug) }}">
                                <img src="{{ url($post->getPrevious()->getImage()) }}" alt="">
                    ...
                    <div class="col-md-6">
                        @if($post->hasNext())
                            ...
                            <a href="{{ route('post.show', $post->getNext()->slug) }}">
                                <img src="{{ url($post->getNext()->getImage()) }}" alt="">
                ...
                <div class="bottom-comment"><!--bottom comment-->
                    ...
                    <div class="comment-img">
                        <img class="img-circle" src="{{ $comment->author->getImage() }}" width="75" height="75" alt="">
                    </div>
